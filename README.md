...
> `1265c85b-d13d-4c84-8252-315987c2ab7b` is the password of the certificate, you can change it to any password you want.
...
* `BookStore.Application.Tests`: Application layer tests.
* `BookStore.Domain.Tests`: Domain layer tests.
* `BookStore.EntityFrameworkCore.Tests`: Entity Framework Core integration tests.
